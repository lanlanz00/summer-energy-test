...
questions = [
    ...
    {
        "q": "面对空闲时间，你的模式更接近？",
        "options": ["优先动起来，越忙越畅快", "优先犒劳自己，享受感官快乐", "优先慢下来，随节奏松弛"],
        "type": "energy"
    },
    {
        "q": "在夏日消费，你更愿意为哪一类买单？",
        "options": ["居家好物", "特色美食", "运动装备"],
        "type": "energy"
    },
    {
        "q": "以下哪一个是你脑海浮现的完美夏日画面？",
        "options": ["街边欢聚，美食冷饮摆满桌面", "树荫暖阳下，静坐悠然放空", "迎着风奔跑，浑身酣畅出汗"],
        "type": "energy"
    },
    {
        "q": "周末朋友邀约，你内心更期待？",
        "options": ["一起竞技运动，活力互动", "少数好友轻陪伴，不刻意喧闹", "结伴吃喝闲聊，热热闹闹"],
        "type": "energy"
    }
]
...
def get_energy_key(opt_text):
    # sport 运动能量
    if opt_text in ["优先动起来，越忙越畅快","运动装备","迎着风奔跑，浑身酣畅出汗","一起竞技运动，活力互动"]:
        return "sport"
    # life 美食生活能量
    elif opt_text in ["优先犒劳自己，享受感官快乐","特色美食","街边欢聚，美食冷饮摆满桌面","结伴吃喝闲聊，热热闹闹"]:
        return "life"
    # love 日光瑜伽松弛能量
    elif opt_text in ["优先慢下来，随节奏松弛","居家好物","树荫暖阳下，静坐悠然放空","少数好友轻陪伴，不刻意喧闹"]:
        return "love"
    return None
# 同分随机选能量
def calc_result():
...
# ----------------------结果页 result【消除顶部空白，紧凑一屏】----------------------
    ...
    <div style="text-align:center; max-width:520px; margin:0.4rem auto; padding:0 16px;">
        ...
        <p style="font-size:0.95rem; color:#444; line-height:1.4; margin:0;">{info['desc']}</p>
        <p style="font-size:1rem;margin-top:4px;color:#d64848;">✨ {info['slogan']}</p>
    </div>
    """, unsafe_allow_html=True)
